...
//         <p className="text-slate-600 text-sm">Join Appointege and start managing appointments</p>
//       </div>
...
//         <div className="space-y-2">
//           <Label htmlFor="phoneNumber" className="text-slate-700 font-medium text-sm">Phone Number</Label>
//           <div className="relative">
...
//         >
//           {isLoading ? 'Creating Account...' : 'Create Account & Start Managing'}
//         </Button>
//       </form>
